...
PROMPT_PATTERNS = {
    ...
    "quac": [
        (
            "{background}\n\n{context}\n\nAnswer the following question by taking a quote from the article: {question}",
            "{answer}",
        ),
        (
            "{background}\n\n{context}\n\nUsing a quote from the above article, answer the following question: {question}",
            "{answer}",
        ),
        (
        ...
        (
            '{context}\n\nAnswer this question "{question}" by extracting the answer from the text above.',
            "{answer}",
        ),
        (
    ...
    "fix_punct": [
        ...
        (
            "Generate a correctly punctuated version of the following text: {no_punct}",
            "{answer}",
        ),
        (
    ...
    "word_segment": [
        ...
        (
            "Write the following list of characters into a correctly formed sentence: {no_space}",
            "{answer}",
        ),
    ...
    "opinion_abstracts_rotten_tomatoes": [
        ...
        (
            "The critic consesnsus is: {critic_consensus}. What reviews supported this critic consensus?",
            "{numbered_reviews}",
        ),
    ...
    "dart": [
        ...
        (
            "Generate an approximately fifteen-word sentence that describes all this data: {tripleset}",
            "{target}",
        ),
        (
    ...
    "e2e_nlg": [
        (
            "Attributes: {meaning_representation}. Produce a detailed sentence about this restaurant.",
            "{target}",
        ),
        (
            "Data: {meaning_representation}. Can you generate a sentence about this data?",
            "{target}",
        ),
        (
            "Data: {meaning_representation}. What is a sentence that describe this data?",
            "{target}",
        ),
        (
            "Here are some keywords about a restaurant:\n\n{meaning_representation}. Write a sentence that describes the following attributes of a restaurant.",
            "{target}",
        ),
        (
    ...
    "web_nlg_en": [
        ...
        (
            "Produce a long descriptive sentence that uses all these words: {input_string}",
            "{target}",
        ),
        (
            "Generate an approximately fifteen-word sentence that describes all this data: {input_string}",
            "{target}",
        ),
        (
    ...
    "cola": [
        ...
        (
            "Produce a brief English sentence that would be considered grammatically {answer}",
            "{sentence}",
        ),
    ],
    "sst2": [
    ...
    "stsb": [
        ...
        (
            "{sentence2}\n\nWhat is a sentence that would be (on a scale from 0 to 5) a {answer_str} out of 5 in terms of textual similarity to the above sentence?",
            "{sentence1}",
        ),
    ],
    "hellaswag": [
    ...
    "openbookqa": [
        ...
        (
            'What sentence would provide a factual answer to this question: "{question}"',
            "{fact}",
        ),
